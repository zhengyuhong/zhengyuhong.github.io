---
title: "DataFlow-Harness: A Grounded Code-Agent Platform for Constructing Editable LLM Data Pipelines 图解"
date: 2026-07-28
tags: [技术, Agent, LLM, 数据流水线, harness]
summary: DataFlow-Harness 的重点不是让 Agent 写一次性脚本，而是把 Agent 放进可编辑、可验证、可回滚的 pipeline harness 里。
---

# DataFlow-Harness: A Grounded Code-Agent Platform for Constructing Editable LLM Data Pipelines 图解
